...
var footstep_sounds_elevator = ["res://Assets/Sounds/World/Elevator/ElevatorStep1.wav", "res://Assets/Sounds/World/Elevator/ElevatorStep2.wav", "res://Assets/Sounds/World/Elevator/ElevatorStep3.wav", "res://Assets/Sounds/World/Elevator/ElevatorStep4.wav"]
var step_sound_dict = {
	"concrete" : [footstep_sounds_concrete, footstep_sounds_concrete_slow],
	"elevator" : [footstep_sounds_elevator, footstep_sounds_elevator]
}
const SPEED = 2.5
